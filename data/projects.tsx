...
export const projects: Project[] = [
  ...
  {
    title: translate({
      id: 'project.linuxpostinstallscript.title',
      message: 'Linux post install script',
      description: 'Title for Linux post install script project',
    }),
    description: translate({
      id: 'project.linuxpostinstallscript.description',
      message: 'Personal, Flexible and Simple for Ubuntu 23.10 and derivates as a Debian. (DevOps, Cloud Engineer, SRE Tools)',
      description: 'Description for Linux Post install script project',
    }),
    website: 'https://github.com/fernandogprieto/fgp-linux-post-install-script',
    tags: ['opensource', 'personal'],
    type: 'other',
  },
  //AI
